...
//        final ArrayList<Unit> list = new ArrayList<Unit>() ;
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(part2.this);
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                LessonPart2Adapter myAdapter = new LessonPart2Adapter(getApplication(), unitList);
                ...
                new Response.ErrorListener(){
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(part2.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
