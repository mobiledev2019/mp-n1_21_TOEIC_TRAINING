...
public class LessonAdpater extends RecyclerView.Adapter<LessonAdpater.MyViewHolder>{
    private Context mContext;
    private List<Unit> mData;

    public LessonAdpater(Context mContext, List<Unit> mData) {
        this.mContext = mContext;
        this.mData = mData;
    }

    @Override
    public LessonAdpater.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view ;
        LayoutInflater inflater = LayoutInflater.from(mContext);
        view = inflater.inflate((R.layout.cart_item_lesson), viewGroup, false);

        return new LessonAdpater.MyViewHolder(view);
    }
