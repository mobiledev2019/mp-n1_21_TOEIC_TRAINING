...
public class LessonPart2Adapter  extends RecyclerView.Adapter<LessonPart2Adapter.MyViewHolder>{
    private Context mContext;
    private List<Unit> mData;

    public LessonPart2Adapter(Context mContext, List<Unit> mData) {
        this.mContext = mContext;
        this.mData = mData;
    }

    @Override
    public LessonPart2Adapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view ;
        LayoutInflater inflater = LayoutInflater.from(mContext);
        view = inflater.inflate((R.layout.cart_item_lesson), viewGroup, false);

        return new LessonPart2Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(LessonPart2Adapter.MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, lesson_part2.class);
